...
const LayoutWrapper = ({ children, SiteLogo, BackToPrev, NextPage, SiteTitle,BgclassName,topHeaderName,bottomHeaderName}) => {
				...
				<Affix offsetTop={0} style={{ zIndex: 16 }}>
					<Header className={`bottom-header  ${bottomHeaderName}`}>
						...
						<Link href="/">
							...
							{BackToPrev &&
								<button className="back-to-preview"><HiArrowLeft /></button>
							}
